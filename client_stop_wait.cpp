...
void request_file(int sockfd)
{
    ...
    // initialize with seqno 1 so that when it is sent again the server understands it as a NAK
    file_request.seqno = 1;
